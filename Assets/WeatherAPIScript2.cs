...
public class WeatherAPIScript2 : MonoBehaviour
{
    ...
    string url = "https://api.openweathermap.org/data/2.5/weather?lat=17.385&lon=78.4867&APPID=2d0df69a4777fa2a9c40a74b6788a94c&units=imperial";
    ...
    IEnumerator GetRequest(string uri)
    {
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            else
            {
                ...
                weatherTextObject.GetComponent<TextMeshPro>().text = "" + finalTempC.ToString() + "°C\n" + conditions;
            }
        }
    }
}
